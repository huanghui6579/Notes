...
import com.yunxinlink.notes.lockpattern.Alp;
    ...
    public static class Display {
        ...
        public static boolean isStealthMode(@NonNull Context context) {
            return p(context).getBoolean(
                    ...
                    context.getResources().getBoolean(R.bool.alp_pkey_display_stealth_mode_default)
            );
        }//isStealthMode()
        ...
        public static int getMinWiredDots(@NonNull Context context) {
            return p(context).getInt(
                    ...
                    context.getResources().getInteger(R.integer.alp_pkey_display_min_wired_dots_default)
            );
        }//getMinWiredDots()
        ...
        public static int validateMinWiredDots(@NonNull Context context, int v) {
            if (v <= 0 || v > 9) v = context.getResources().getInteger(R.integer.alp_pkey_display_min_wired_dots_default);
            return v;
        ...
        public static int getMaxRetries(@NonNull Context context) {
            return p(context).getInt(
                    ...
                    context.getResources().getInteger(R.integer.alp_pkey_display_max_retries_default)
            );
        }//getMaxRetries()
        ...
        public static int validateMaxRetries(@NonNull Context context, int v) {
            if (v <= 0) v = context.getResources().getInteger(R.integer.alp_pkey_display_max_retries_default);
            return v;
        }//validateMaxRetries()
        ...
        public static int getCaptchaWiredDots(@NonNull Context context) {
            return p(context).getInt(
                    context.getString(R.string.alp_pkey_display_captcha_wired_dots),
                    context.getResources().getInteger(R.integer.alp_pkey_display_captcha_wired_dots_default)
            );
        }//getCaptchaWiredDots()
        ...
        public static int validateCaptchaWiredDots(@NonNull Context context, int v) {
            if (v <= 0 || v > 9) v = context.getResources().getInteger(R.integer.alp_pkey_display_captcha_wired_dots_default);
            return v;
    ...
    public static class Security {
        ...
        public static boolean isAutoSavePattern(@NonNull Context context) {
            return p(context).getBoolean(
                    ...
                    context.getResources().getBoolean(R.bool.alp_pkey_sys_auto_save_pattern_default)
            );
        }//isAutoSavePattern()
        ...
        public static void setAutoSavePattern(@NonNull Context context, boolean v) {
            p(context).edit().putBoolean(context.getString(R.string.alp_pkey_sys_auto_save_pattern), v).commit();
