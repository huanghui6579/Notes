...
import com.yunxinlink.notes.lockpattern.utils.FloatAnimator;
...
public class LockPatternView extends View {
    ...
    public LockPatternView(Context context, AttributeSet attrs) {
        ...
        final TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.Alp_LockPatternView);

        final String aspect = a.getString(R.styleable.Alp_LockPatternView_alp_aspect);
        ...
        mRegularColor = context.getResources().getColor(
                ResourceUtils.resolveResourceId(context, R.attr.alp_color_lock_pattern_view_regular)
        );
        mErrorColor = context.getResources().getColor(
                ResourceUtils.resolveResourceId(context, R.attr.alp_color_lock_pattern_view_error)
        );
        mSuccessColor = context.getResources().getColor(
                ResourceUtils.resolveResourceId(context, R.attr.alp_color_lock_pattern_view_success)
        );

        mRegularColor = a.getColor(R.styleable.Alp_LockPatternView_alp_regularColor, mRegularColor);
        mErrorColor = a.getColor(R.styleable.Alp_LockPatternView_alp_errorColor, mErrorColor);
        mSuccessColor = a.getColor(R.styleable.Alp_LockPatternView_alp_successColor, mSuccessColor);

        int pathColor = a.getColor(R.styleable.Alp_LockPatternView_alp_pathColor, mRegularColor);
        ...
        mPathWidth = context.getResources().getDimensionPixelSize(R.dimen.alp_lock_pattern_dot_line_width);
        mPathPaint.setStrokeWidth(mPathWidth);

        mDotSize = context.getResources().getDimensionPixelSize(R.dimen.alp_lock_pattern_dot_size);
        mDotSizeActivated = context.getResources().getDimensionPixelSize(R.dimen.alp_lock_pattern_dot_size_activated);
