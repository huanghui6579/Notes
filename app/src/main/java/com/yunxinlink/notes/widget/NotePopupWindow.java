...
public class NotePopupWindow extends PopupWindow {
    ...
    public NotePopupWindow(@NonNull Context context, @Nullable AttributeSet attrs,
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs,
                android.support.v7.appcompat.R.styleable.PopupWindow, defStyleAttr, defStyleRes);
        if (a.hasValue(android.support.v7.appcompat.R.styleable.PopupWindow_overlapAnchor)) {
            setSupportOverlapAnchor(a.getBoolean(android.support.v7.appcompat.R.styleable.PopupWindow_overlapAnchor, false));
        }
        // We re-set this for tinting purposes
        setBackgroundDrawable(a.getDrawable(android.support.v7.appcompat.R.styleable.PopupWindow_android_popupBackground));
        ...
        if (defStyleRes != 0 && sdk < 11) {
            ...
            if (a.hasValue(android.support.v7.appcompat.R.styleable.PopupWindow_android_popupAnimationStyle)) {
                setAnimationStyle(a.getResourceId(
                        android.support.v7.appcompat.R.styleable.PopupWindow_android_popupAnimationStyle, -1));
            }
        }
    ...
    private static void wrapOnScrollChangedListener(final PopupWindow popup) {
        try {
            ...
            final ViewTreeObserver.OnScrollChangedListener originalListener =
                    (ViewTreeObserver.OnScrollChangedListener) fieldListener.get(popup);
